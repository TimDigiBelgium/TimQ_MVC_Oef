...
namespace TimQ_MVC_Oef.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            List<Component> componentsList = GetComponentsFromCategorieID(id);

           
            ViewData["ComponentsList"] = componentsList;
            return View(categorie);
        }

        public List<Component> GetComponentsFromCategorieID(int? id)
        {

            List<Component> components;

            components = (from p in db.Components
                      where p.CategorieID ==id
                      select p).ToList();
